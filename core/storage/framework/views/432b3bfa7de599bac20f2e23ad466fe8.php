                            ...
                            <div class="card-body">
                                    <form class="form-horizontal" action="<?php echo e(route('admin.funfact.update', $funfact->id)); ?>" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <img class="mw-400 mb-3 show-img img-demo" src="<?php echo e(asset('assets/front/img/'.$funfact->icon)); ?>" alt="">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skynet\core\resources\views/admin/funfact/edit.blade.php ENDPATH**/ ?>