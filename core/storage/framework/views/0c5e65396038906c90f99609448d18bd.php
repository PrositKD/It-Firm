					...
					<a href="<?php echo e(route('front.blogdetails', $blog->slug)); ?>" class="single-blog">
						...
						<div class="content">
							<ul class="top-meta">
								...
								<h4 class="title">
									<?php echo e((mb_strlen(strip_tags(Helper::convertUtf8($blog->title))) > 50) ? mb_substr(strip_tags(Helper::convertUtf8($blog->title)), 0, 50) . '...' : strip_tags(Helper::convertUtf8($blog->title))); ?>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skynet\core\resources\views/front/index.blade.php ENDPATH**/ ?>