            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1"><?php echo e(__('Add Offer')); ?></h3>
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.offer.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="offer" class="form-control summernote"  rows="3" placeholder="<?php echo e(__('Offer')); ?>"><?php echo e(old('name')); ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skynet\core\resources\views/admin/offer/add.blade.php ENDPATH**/ ?>