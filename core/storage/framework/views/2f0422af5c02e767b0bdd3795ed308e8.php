                    ...
                    <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.package.update',  $package->id)); ?>" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-2 control-label"><?php echo e(__('Speed')); ?><span class="text-danger">*</span></label>
        
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="speed" placeholder="<?php echo e(__('Speed')); ?>" value="<?php echo e($package->speed); ?>">
                                            <?php if($errors->has('speed')): ?>
                                                <p class="text-danger"> <?php echo e($errors->first('speed')); ?> </p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-sm-2 control-label"><?php echo e(__('Time')); ?><span class="text-danger">*</span></label>
        
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="time" placeholder="<?php echo e(__('Time')); ?>" value="<?php echo e($package->time); ?>">
                                            <?php if($errors->has('time')): ?>
                                                <p class="text-danger"> <?php echo e($errors->first('time')); ?> </p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skynet\core\resources\views/admin/package/edit.blade.php ENDPATH**/ ?>