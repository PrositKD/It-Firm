...
.gradint_body .blog-sidebar .widget.search-widget form button, .gradint_body .main-btn,
...
.gradint_body .header-navigation.breakpoint-on .site-nav-menu
{
    background-image: -webkit-linear-gradient(to right, <?php echo $g1 ?>, <?php echo $g2 ?>, <?php echo $g3 ?>);
    background-image: -moz-linear-gradient(to right, <?php echo $g1 ?>, <?php echo $g2 ?>, <?php echo $g3 ?>);
    background-image: -ms-linear-gradient(to right, <?php echo $g1 ?>, <?php echo $g2 ?>, <?php echo $g3 ?>);
    background-image: linear-gradient(to right, <?php echo $g1 ?>, <?php echo $g2 ?>, <?php echo $g3 ?>);
}
